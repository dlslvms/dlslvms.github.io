...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header"><i class="fa fa-user fa-fw"></i>Active Visitors</h2>
        </div>
    </div>
            ...
            <div class="panel-body">   
                ...
                <table width="100%" class="table table-bordered table-hover dataTable" id="visitorTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 80px;">Checked In</th>
                            </bold>
                        </tr>
                    </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$visitor->timein_at}}</td>
                    </tr>
                    @endforeach
                </tbody>                
                </table>         
