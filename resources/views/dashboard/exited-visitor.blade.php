...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header"><i class="fa fa-sign-out fa-fw"></i>Exited Visitors</h2>
        </div>
    </div>
                ...
                <table width="100%" class="table table-bordered table-hover dataTable" id="visitorTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 80px;">Visitor Type</th>
                            <th class="text-center" style="width: 80px;">Checked Out</th>
                            </bold>
                        </tr>
                    </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$visitor->registration_type}}</td>
                        <td class="text-center">{{$visitor->timeout_at}}</td>
                    </tr>
                    @endforeach
                </tbody>                
                </table>         
